...
export declare const UserDehiveSchema: import("mongoose").Schema<UserDehive, import("mongoose").Model<UserDehive, any, any, any, Document<unknown, any, UserDehive, any> & UserDehive & Required<{
    ...
    __v: number;
}, any>, {}, {}, {}, {}, import("mongoose").DefaultSchemaOptions, UserDehive, Document<unknown, {}, import("mongoose").FlatRecord<UserDehive>, {}> & import("mongoose").FlatRecord<UserDehive> & Required<{
    _id: unknown;
}> & {
    __v: number;
}>;
