...
export declare const DirectConversationSchema: import("mongoose").Schema<DirectConversation, import("mongoose").Model<DirectConversation, any, any, any, Document<unknown, any, DirectConversation, any, {}> & DirectConversation & {
    ...
    __v: number;
}, any>, {}, {}, {}, {}, import("mongoose").DefaultSchemaOptions, DirectConversation, Document<unknown, {}, import("mongoose").FlatRecord<DirectConversation>, {}, import("mongoose").ResolveSchemaOptions<import("mongoose").DefaultSchemaOptions>> & import("mongoose").FlatRecord<DirectConversation> & {
    _id: Types.ObjectId;
} & {
    __v: number;
}>;
