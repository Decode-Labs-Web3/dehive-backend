...
class CreateChannelDto {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { name: { required: true, type: () => String, minLength: 1, maxLength: 100 }, type: { required: true, enum: require("./create-channel.dto").ChannelType }, topic: { required: false, type: () => String, minLength: 0, maxLength: 1024 } };
    }
}
