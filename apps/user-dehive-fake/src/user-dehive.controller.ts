...
export class UserDehiveController {
  ...
  async getUserProfile(
    ...
    return await this.userDehiveService.getUserProfile(
      user_id,
      decode_auth_token,
    );
  }
  ...
  async getFriendRequestsPage(
    @Headers('Authorization') auth: string,
    @Param('page') page: number,
    @Param('page_size') page_size: number,
  ) {
    return await this.userDehiveService.getFriendRequestsPage(
      auth,
      page,
      page_size,
    );
  ...
  async getMyRequestsPage(
    ...
    return await this.userDehiveService.getMyRequestsPage(
      auth,
      page,
      page_size,
    );
  ...
  async getFriendsSuggestionsPage(
    ...
    return await this.userDehiveService.getFriendsSuggestionsPage(
      auth,
      page,
      page_size,
    );
  ...
  async checkUserToUserRelationship(
    ...
    return await this.userDehiveService.checkUserToUserRelationship(
      auth,
      to_user_id,
    );
  }
  ...
  async getMutualFriendsPage(
    ...
    return await this.userDehiveService.getMutualFriendsPage(
      auth,
      other_user_id,
      page,
      page_size,
